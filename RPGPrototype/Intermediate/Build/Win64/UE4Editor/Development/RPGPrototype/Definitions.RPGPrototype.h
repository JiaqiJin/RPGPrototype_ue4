...
#define UE_PROJECT_NAME RPGPrototype
#define UE_TARGET_NAME RPGPrototypeEditor
#define UE_MODULE_NAME "RPGPrototype"
...
#define RPGPROTOTYPE_API DLLEXPORT
