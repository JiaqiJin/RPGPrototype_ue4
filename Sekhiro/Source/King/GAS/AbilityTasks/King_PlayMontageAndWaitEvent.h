...
#include "King_PlayMontageAndWaitEvent.generated.h"

class UKing_AbilitySystemComponent;

/** Delegate type used, EventTag and Payload may be empty if it came from the montage callbacks */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FKINGPlayMontageAndWaitForEvent, FGameplayTag, EventTag, FGameplayEventData, EventData);
 ...
 */
UCLASS()
class KING_API UKing_PlayMontageAndWaitEvent : public UAbilityTask
{
	GENERATED_BODY()
public:
	// Constructor and overrides
	UKing_PlayMontageAndWaitEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	FKINGPlayMontageAndWaitForEvent OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FKINGPlayMontageAndWaitForEvent OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FKINGPlayMontageAndWaitForEvent OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FKINGPlayMontageAndWaitForEvent OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FKINGPlayMontageAndWaitForEvent EventReceived;
	...
	UFUNCTION(BlueprintCallable, Category = "Ability|Tasks", meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"))
		static UKing_PlayMontageAndWaitEvent* PlayMontageAndWaitForEvent(
...
private:
	...
	UKing_AbilitySystemComponent* GetTargetASC();
